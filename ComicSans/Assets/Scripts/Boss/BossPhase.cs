...
public class BossPhase : ScriptableObject {
    ...
    [Tooltip("The time the Boss will not take damage from hits.")]
    ...
    [Tooltip("When below this life the Boss will go to the next phase on the BossScript phases list. NOTE: If this is the last phase set this number to a negative value.")]
